class SnakesLadders():
    ...
    def __init__(self):
        self.dict={2:38,7:14,8:31,15:26,21:42,28:84,36:44,51:67,71:91,78:98,87:94,16:6,49:11,46:25,62:19,64:60,74:53,89:68,99:80,95:75,92:88}
        self.index=0
        self.player=[1,2]
        self.mark=[0,0]
        self.win=False
    def play(self, die1, die2):
        if self.win: return 'Game over!'
        temp=self.index%2
